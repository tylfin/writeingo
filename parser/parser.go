...
// parsePrefixExpression needs to take the prefix, either ! or -, then use the rest of the token in a recursive
// call to parseExpression
...
func (p *Parser) parseBoolean() ast.Expression {
	boolean := &ast.Boolean{Token: p.curToken, Value: p.curTokenIs(token.TRUE)}
	return boolean
}
